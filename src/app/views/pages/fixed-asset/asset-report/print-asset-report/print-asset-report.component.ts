...
@Component({
  selector: 'kt-print-asset-report',
  templateUrl: './print-asset-report.component.html',
  styleUrls: ['./print-asset-report.component.scss']
})
export class PrintAssetReportComponent extends AppComponentBase implements OnInit {
