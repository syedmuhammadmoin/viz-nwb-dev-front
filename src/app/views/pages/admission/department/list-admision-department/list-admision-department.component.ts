...
@Component({
  selector: 'kt-list-admision-department',
  templateUrl: './list-admision-department.component.html',
  styleUrls: ['./list-admision-department.component.scss']
})
export class ListAdmisionDepartmentComponent extends AppComponentBase implements OnInit {
...
openDialog(id?: number): void {
  const dialogRef = this.dialog.open(CreateAddmissionDepartmentComponent, {
    width: '800px',
    data: id
  });
